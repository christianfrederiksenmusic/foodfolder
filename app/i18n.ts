...
export const I18N: Record<Lang, Record<TKey, string>> = {
  da: {
    ...
    image_card_title: "Scan køleskab / skab",
    image_card_subtitle: "Upload et foto af dit køleskab, skab eller ingredienshylde, så finder Quartigo dine varer.",
    upload: "Vælg foto",
    analyze: "Find varer",
    analyzing: "Analyserer...",
    tap_to_choose: "Klik for at vælge et foto af køleskab eller skab",
  ...
  en: {
    ...
    image_card_title: "Scan fridge / pantry",
    image_card_subtitle: "Upload a photo of your fridge, cupboard, or pantry shelf and Quartigo will detect the ingredients.",
    upload: "Vælg foto",
    analyze: "Find items",
    analyzing: "Analyzing...",
    tap_to_choose: "Click to choose a fridge or pantry photo",
